...
Are there any sequences that Solomonoff induction *cannot* predict? The short answer is yes there are, but the [kinds of computers needed](https://en.wikipedia.org/wiki/Hypercomputation) to be able to predict these sequences don't exist in the real world, and it's unlikely that we'll ever be able to build them.
