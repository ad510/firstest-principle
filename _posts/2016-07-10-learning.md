...
<a id="update-quantum"></a>**UPDATE**: A couple people suggested that this can be described by using the [many-worlds interpretation](https://en.wikipedia.org/wiki/Many-worlds_interpretation) of quantum mechanics, but that isn't the problem here. The real problem is that quantum mechanics does not tell you how to partition the quantum state of "you" from the quantum state of the rest of the universe, and this particular problem is extremely sensitive to how you do that. Usually you can [work around this](https://en.wikipedia.org/wiki/Quantum_decoherence) by using techniques such as partial traces, but I'm not sure whether that would be enough in this situation. I'm still looking into this as of 8/23/2016, and I plan to rewrite the section above after I understand this better.
