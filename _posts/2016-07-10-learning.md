...
<a id="update-quantum"></a>**UPDATE**: A couple people suggested that this can be described by using the [many-worlds interpretation](https://en.wikipedia.org/wiki/Many-worlds_interpretation) of quantum mechanics. I agree with that, but I'm not sure that would be enough to be able to predict the probabilities of you seeing a 0 or a 1. You'd still run into the problem that the standard model does not tell you how to partition the quantum state of "you" from the quantum state of the rest of the universe, and this particular problem is extremely sensitive to how you do that. Usually you can [work around this](https://en.wikipedia.org/wiki/Quantum_decoherence) by using techniques such as partial traces, but I'm not sure whether that would be enough in this situation. If you can help me understand this better, then I'd really appreciate it if you email me at [firstestprinciple@gmail.com](mailto:firstestprinciple@gmail.com). I'm still looking into this as of 9/3/2016, and I plan to rewrite the section above after I understand this better.

In the meantime, you can go to Scott Aaronson's [lecture on free will](http://scottaaronson.com/democritus/lec18.html) and search "Mars Express." In one part, he lists several unsolved questions about its feasibility and says, "These are not metaphysical questions. They are, in principle, empirically answerable ones." You can think of this blog post as proposing one way to empirically answer some of these questions.
