...
**UPDATE**: I got an email from someone saying that you actually can use the [many-worlds interpretation](https://en.wikipedia.org/wiki/Many-worlds_interpretation) of quantum mechanics in the situation I describe, which would imply that this isn't a situation that can only be handled using learning algorithms. I sent a reply email back and I plan to do a more thorough update to the blog post after I understand this better.
...
**UPDATE**: I got an email from someone saying that you actually can use the [many-worlds interpretation](https://en.wikipedia.org/wiki/Many-worlds_interpretation) of quantum mechanics here, which would imply that this isn't a situation that can only be handled using learning algorithms. I sent a reply email back and I plan to do a more thorough update to the blog post after I understand this better. If you can explain how to predict the outcome of this situation using quantum mechanics, please email me at [firstestprinciple@gmail.com](mailto:firstestprinciple@gmail.com) so I can explain it in the blog post.
