...
**UPDATE**: I got an email from someone saying that you actually can use the [many-worlds interpretation](https://en.wikipedia.org/wiki/Many-worlds_interpretation) of quantum mechanics in the situation I describe, which would imply that this isn't a situation that can only be handled using information physics. I sent a reply email back and I plan to do a more thorough update to the blog post after I understand this better.
...
**UPDATE**: I got an email from someone saying that you actually can use the [many-worlds interpretation](https://en.wikipedia.org/wiki/Many-worlds_interpretation) of quantum mechanics here, which would imply that this isn't a situation that can only be handled using information physics. I sent a reply email back and I plan to do a more thorough update to the blog post after I understand this better.
