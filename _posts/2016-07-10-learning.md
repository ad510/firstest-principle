...
**UPDATE**: I've been contacted by a couple people saying that you can describe this by using the [many-worlds interpretation](https://en.wikipedia.org/wiki/Many-worlds_interpretation) of quantum mechanics. The reason I think this is problematic is that to model this with quantum mechanics, you'd want both possibilities to start out with identical quantum states, then have the quantum states diverge after you make a measurement. But in any conventional model based on fundamental particles, the 2 computers in this situation would start out with different quantum states to begin with. Also, keep in mind that the physics used inside the simulation does not necessarily have to be the same as physics in real life.

If you can explain to me the right way to model this using quantum mechanics, then I'd really appreciate it if you email me at [firstestprinciple@gmail.com](mailto:firstestprinciple@gmail.com). If you are a physicist for which this is really obvious, I'm sorry for asking you to deal with an idiot like me who doesn't know better, but I promise to write a detailed update to the blog post after I understand this better.
