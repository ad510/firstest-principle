...
<a id="update-quantum"></a>**UPDATE 8/5/2016**: I belatedly rewrote this section due to reader feedback. Thanks guys! (Here's the [original version](https://github.com/ad510/firstest-principle/blob/daa34b2e94f8d508b8a4141b58217c8f5445d798/_posts/2016-07-10-learning.md#what-our-physics-theories-cant-predict).)
...
The way measurement works in quantum mechanics is that when you measure something, the quantum state of "you" becomes *entangled*, or correlated with, the quantum state of the thing you measured. For example, if the quantum state of "your thoughts" is entangled with the quantum state of a kitten standing in front of you, an oversimplified plain English translation is that what you *think* the kitten is doing probably has something to do with what the kitten is *actually* doing.

But if you want to use the standard model to predict what you'll see in the simulation, even if you are a godlike being who knows the quantum state of the universe, you will run into a deep, fundamental problem, which is that defining {Partitioning} the quantum state of "you" is *extremely* hard. What's more, the standard model will *not* give you any guidance on how to do it!

{1st sentence of next paragraph}
{for details on why you can't just define "you" as quantum state of every particle in your brain, see free will lecture. also keep in mind you can do crazy things to "you" like WBW swap half brain with another person}

Defining the quantum state of "you" is a famous unsolved problem in physics called the [measurement problem](https://en.wikipedia.org/wiki/Measurement_problem). And {So} this isn't just a matter of [interpretation](https://en.wikipedia.org/wiki/Interpretations_of_quantum_mechanics) or needing enough computational resources. In order to correctly predict the probabilities of seeing a 0 or a 1, you have to take a wild, uninformed guess at how to partition the quantum state of the universe into the subsystem that is "you" and the subsystem that is "not you," and it has to be accurate enough to correctly predict:
...
If your wild guess isn't *that* accurate, then the standard model will likely make a *very* wrong prediction.

```
due to decoherence, everyone usually agrees about what is happening, but not in this case
doesn't matter much if you want to figure out what atoms in objects are going to do, but matters very much for questions like "0 or 1" and I think it'll become very important once we make sufficiently good brain-computer interfaces
