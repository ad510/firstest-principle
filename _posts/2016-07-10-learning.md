...
```
current best guess of defining events: after converting pure state of you now to mixed state of you when displaying 0/1, what is probability that von Neumann entropy between computer & pure state of "real you" is greater than cutoff
