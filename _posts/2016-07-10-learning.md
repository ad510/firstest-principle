...
If you know how to determine the amplitudes of seeing a 0 or a 1 in this situation using quantum mechanics, then I'd really appreciate it if you email an explanation to me at [firstestprinciple@gmail.com](mailto:firstestprinciple@gmail.com). Personally, I think the standard model can only apply here if you die before seeing either.
