...
But if you want to use the standard model to predict what you'll see in the simulation, even if you are a godlike being who knows the quantum state of the universe, you will run into a deep, fundamental problem, which is that defining the quantum state of "you" is *extremely* hard. What's more, the standard model will *not* give you any guidance on how to do it!
