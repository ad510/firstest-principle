...
<a id="update-quantum"></a>**UPDATE**: A couple people suggested that this can be described by using the [many-worlds interpretation](https://en.wikipedia.org/wiki/Many-worlds_interpretation) of quantum mechanics, but that isn't the problem here. The real problem is that quantum mechanics does not tell you how to partition the quantum state of "you" from the quantum state of the rest of the universe, and this particular problem is extremely sensitive to how you do that. As of 8/5/2016, I'm working on rewriting the section above to explain this in more detail.
